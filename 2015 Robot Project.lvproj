...
AddOutputFilter chunkFilter
		...
		<Item Name="Auton" Type="Folder">
			<Item Name="Auton go linear distance.vi" Type="VI" URL="../Auton go linear distance.vi"/>
			<Item Name="Auton Turn to disired angle.vi" Type="VI" URL="../Auton Turn to disired angle.vi"/>
			<Item Name="ToteFirstAuton.vi" Type="VI" URL="../ToteFirstAuton.vi"/>
		</Item>
		<Item Name="Fun things" Type="Folder">
			<Item Name="BlinkinLights.vi" Type="VI" URL="../BlinkinLights.vi"/>
			<Item Name="Light cycling.vi" Type="VI" URL="../Light cycling.vi"/>
			<Item Name="Light fade.vi" Type="VI" URL="../Light fade.vi"/>
			<Item Name="LightSetup.vi" Type="VI" URL="../LightSetup.vi"/>
		</Item>
		<Item Name="Globals" Type="Folder">
			<Item Name="DriveGlobal.vi" Type="VI" URL="../DriveGlobal.vi"/>
			<Item Name="Global Ref.vi" Type="VI" URL="../Global Ref.vi"/>
			<Item Name="Robot Fail.vi" Type="VI" URL="../Robot Fail.vi"/>
		</Item>
		...
		<Item Name="Team Code" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Tote Motor Update.vi" Type="VI" URL="../Tote Motor Update.vi"/>
			<Item Name="Autonomous Independent.vi" Type="VI" URL="../Autonomous Independent.vi"/>
			<Item Name="Begin.vi" Type="VI" URL="../Begin.vi"/>
			<Item Name="Disabled.vi" Type="VI" URL="../Disabled.vi"/>
			<Item Name="Finish.vi" Type="VI" URL="../Finish.vi"/>
			<Item Name="Lift Control.vi" Type="VI" URL="../Lift Control.vi"/>
			<Item Name="Lift Encoder get.vi" Type="VI" URL="../Lift Encoder get.vi"/>
			<Item Name="Periodic Tasks.vi" Type="VI" URL="../Periodic Tasks.vi"/>
			<Item Name="RobotDrive.vi" Type="VI" URL="../RobotDrive.vi"/>
			<Item Name="Teleop.vi" Type="VI" URL="../Teleop.vi"/>
			<Item Name="Test.vi" Type="VI" URL="../Test.vi"/>
			<Item Name="Vision Processing.vi" Type="VI" URL="../Vision Processing.vi"/>
			<Item Name="ToteStoppercontrol.vi" Type="VI" URL="../ToteStoppercontrol.vi"/>
			<Item Name="OpenClose Arms.vi" Type="VI" URL="../OpenClose Arms.vi"/>
		</Item>
		<Item Name="TypeDefs" Type="Folder">
			<Item Name="DriverAxis.ctl" Type="VI" URL="../DriverAxis.ctl"/>
			<Item Name="DriverButtons.ctl" Type="VI" URL="../DriverButtons.ctl"/>
			<Item Name="Global Ref typedef.ctl" Type="VI" URL="../Global Ref typedef.ctl"/>
			<Item Name="OpAxis.ctl" Type="VI" URL="../OpAxis.ctl"/>
			<Item Name="OpButtons.ctl" Type="VI" URL="../OpButtons.ctl"/>
			<Item Name="Robot Values typedef.ctl" Type="VI" URL="../Robot Values typedef.ctl"/>
		</Item>
		<Item Name="Utility" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Arcade Drive Translate.vi" Type="VI" URL="../Arcade Drive Translate.vi"/>
			<Item Name="Drive Encoder Get.vi" Type="VI" URL="../Drive Encoder Get.vi"/>
			<Item Name="GetLastTrue.vi" Type="VI" URL="../GetLastTrue.vi"/>
			<Item Name="Drive Toggle.vi" Type="VI" URL="../Drive Toggle.vi"/>
			<Item Name="encoder rotation.vi" Type="VI" URL="../encoder rotation.vi"/>
			<Item Name="NetworkTable get.vi" Type="VI" URL="../NetworkTable get.vi"/>
			<Item Name="ParseJoystickValues.vi" Type="VI" URL="../ParseJoystickValues.vi"/>
			<Item Name="Auton1ToteEnum.ctl" Type="VI" URL="../Auton1ToteEnum.ctl"/>
			<Item Name="Gyro Reset.vi" Type="VI" URL="../Gyro Reset.vi"/>
		</Item>
		<Item Name="Auton Go Backwards.vi" Type="VI" URL="../Auton Go Backwards.vi"/>
		<Item Name="AutonEnum.ctl" Type="VI" URL="../AutonEnum.ctl"/>
		<Item Name="AutonEnumGoAround.ctl" Type="VI" URL="../AutonEnumGoAround.ctl"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="toggle1-26-13.vi" Type="VI" URL="../toggle1-26-13.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Bld_localDestDir" Type="Path">/C/Users/Team1038/Documents/LabVIEW Data/NI_AB_PROJECTNAME/Builds</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{11CAAFAA-AC59-461B-901A-0B1DDAF08CF0}</Property>
